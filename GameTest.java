...
//		GameTree tree = new GameTree(gameNodes, hypotheticalMove, player1.getPlayerNum(), player2.getPlayerNum(), 3, true);
//		
...
//		// new tree with max depth of three
//		@SuppressWarnings("unused")
//		GameTree tree = new GameTree(gameNodes, hypotheticalMove, player1.getPlayerNum(), player2.getPlayerNum(), 3, false);
//		
//		// checking that nothing untoward happened
//		// the gamestate should NOT have been actually changed.
//		Node[][] gameState2 = game.getGameState();
